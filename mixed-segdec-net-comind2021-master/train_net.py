...
def parse_args():
    ...
    parser.add_argument('--TRAIN_MODE', type=str, default=None, help="Training mode: JOINT or SEG_ONLY.")
    parser.add_argument('--MAX_TRAIN_SAMPLES', type=int, default=None, help="Optional cap on number of training samples for smoke tests.")
    parser.add_argument('--MAX_VAL_SAMPLES', type=int, default=None, help="Optional cap on number of validation/test samples for smoke tests.")
    parser.add_argument('--INPUT_SIZE', type=int, default=None, help="Optional square input size override for DAGM experiments.")
